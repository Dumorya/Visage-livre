<div>
	...
	$postlist = $this->visage_livre_model->visage_livre_get_post_friend_format();
	...
	<?php
	$mypostlist = $this->visage_livre_model->visage_livre_get_post_connected_user();
	foreach ($mypostlist as $my_post_item ) { ?>
	<li>
		<?php $iddoc = $my_post_item['iddoc']; ?>
		<?php echo $my_post_item['auteur']; ?>
		<?php echo " - ".$my_post_item['create_date']; ?><br/>
		<h4><?php echo $my_post_item['content']." "."(".$iddoc.")"." ";?></h4>
