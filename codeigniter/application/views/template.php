...
<html>
	...
	<body>
		<div id ="global">
            <nav class="navbar navbar-default" id="nav">
                <div class="container-fluid">
                    <img src="../public/images/logo_visage_livre.png" class="navbar-logo">
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>public/js/style.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>public/js/smoothScroll.js"></script>
	</body>
</html>
