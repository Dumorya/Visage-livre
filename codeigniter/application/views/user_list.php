<div class="userList">
	...
	<ul>
        ...
        foreach ($otheruser as $user_item ){ ?>
            <li>
                <span><?php echo $user_item['nickname'] ?></span>
                <button class="addFriend" onclick="window.location='<?php echo site_url("visage_livre/send_friend_request/".$this->visage_livre_model->get_user_connected()."/".$user_item['nickname']);?>'; displayNewIcon()">
